...
public class BasicSyncHttpRequest {
    private static HttpClient client;

    public static void main(String[] args) throws IOException, URISyntaxException {
        client = HttpClient.newHttpClient();
        Files.lines(Path.of(Objects.requireNonNull(BasicSyncHttpRequest.class.getClassLoader().getResource("urls.txt")).toURI()))
                .map(BasicSyncHttpRequest::validateLink)
