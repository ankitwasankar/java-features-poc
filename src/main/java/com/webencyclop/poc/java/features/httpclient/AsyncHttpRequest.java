...
public class AsyncHttpRequest {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        var futures = Files.lines(Path.of(Objects.requireNonNull(SyncHttpRequest.class.getClassLoader().getResource("urls.txt")).toURI()))
                .map(AsyncHttpRequest::validateLink)
